...
struct VolumeSnapshot_ {
    shared: StackShared,
    tf_id: String,
    data: RefCell<VolumeSnapshotData>,
}

#[derive(Clone)]
pub struct VolumeSnapshot(Rc<VolumeSnapshot_>);
...
impl Resource for VolumeSnapshot {
    fn extract_ref(&self) -> String {
        format!("{}.{}", self.0.extract_resource_type(), self.0.extract_tf_id())
    }
}

impl Dependable for VolumeSnapshot {
    fn extract_ref(&self) -> String {
        Resource::extract_ref(self)
    }
}

impl ToListMappable for VolumeSnapshot {
    type O = ListRef<VolumeSnapshotRef>;
...
impl Resource_ for VolumeSnapshot_ {
...
pub struct BuildVolumeSnapshot {
    pub tf_id: String,
    #[doc= ""]
...
impl BuildVolumeSnapshot {
    pub fn build(self, stack: &mut Stack) -> VolumeSnapshot {
        let out = VolumeSnapshot(Rc::new(VolumeSnapshot_ {
            shared: stack.shared.clone(),
            tf_id: self.tf_id,
            data: RefCell::new(VolumeSnapshotData {
...
impl Ref for VolumeSnapshotRef {
