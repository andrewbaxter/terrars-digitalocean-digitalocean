...
struct FloatingIp_ {
    shared: StackShared,
    tf_id: String,
    data: RefCell<FloatingIpData>,
}

#[derive(Clone)]
pub struct FloatingIp(Rc<FloatingIp_>);
...
impl Resource for FloatingIp {
    fn extract_ref(&self) -> String {
        format!("{}.{}", self.0.extract_resource_type(), self.0.extract_tf_id())
    }
}

impl Dependable for FloatingIp {
    fn extract_ref(&self) -> String {
        Resource::extract_ref(self)
    }
}

impl ToListMappable for FloatingIp {
    type O = ListRef<FloatingIpRef>;
...
impl Resource_ for FloatingIp_ {
...
pub struct BuildFloatingIp {
    pub tf_id: String,
    #[doc= ""]
    pub region: PrimField<String>,
}

impl BuildFloatingIp {
    pub fn build(self, stack: &mut Stack) -> FloatingIp {
        let out = FloatingIp(Rc::new(FloatingIp_ {
            shared: stack.shared.clone(),
            tf_id: self.tf_id,
            data: RefCell::new(FloatingIpData {
