...
struct DataReservedIp_ {
    shared: StackShared,
    tf_id: String,
    data: RefCell<DataReservedIpData>,
}

#[derive(Clone)]
pub struct DataReservedIp(Rc<DataReservedIp_>);
...
impl Datasource for DataReservedIp {
    fn extract_ref(&self) -> String {
        format!("data.{}.{}", self.0.extract_datasource_type(), self.0.extract_tf_id())
    }
}

impl Dependable for DataReservedIp {
    fn extract_ref(&self) -> String {
        Datasource::extract_ref(self)
    }
}

impl ToListMappable for DataReservedIp {
    type O = ListRef<DataReservedIpRef>;
...
impl Datasource_ for DataReservedIp_ {
    fn extract_datasource_type(&self) -> String {
        "digitalocean_reserved_ip".into()
    }
...
pub struct BuildDataReservedIp {
    pub tf_id: String,
    #[doc= "reserved ip address"]
    pub ip_address: PrimField<String>,
}

impl BuildDataReservedIp {
    pub fn build(self, stack: &mut Stack) -> DataReservedIp {
        let out = DataReservedIp(Rc::new(DataReservedIp_ {
            shared: stack.shared.clone(),
            tf_id: self.tf_id,
            data: RefCell::new(DataReservedIpData {
...
pub struct DataReservedIpRef {
    shared: StackShared,
    base: String,
}

impl Ref for DataReservedIpRef {
